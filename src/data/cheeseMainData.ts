...
export const myBookDefaultMent =
  '좋아하는 책이 없어요! 취향인 책들에 하트 모양을 눌러보세요!';
export const tasteQuestions = [
  {
    q: '새로운 독서 모임에 초대 받았다. 어떤 생각이 드나요?',
    a: [
      [
        'I',
  ...
  {
    q: '책을 읽고 사람들과 이야기를 나누며 보다 넓게 이해하고 에너지도 얻는다.',
    a: [
      ['S', '지금 내가 읽고 있는 부분에 집중한다.'],
      ['N', '소설을 읽을 때 미리 뒷 내용을 상상하며 걱정한다.'],
    ],
  },
  {
    q: '당신은 책을 읽을 때 어떤 부분에 더 주목하나요?',
    a: [
      ['F', '정보 하나하나보다는 정보들이 놓인 맥락이나 패턴에 주목한다.'],
      ['T', '정확히 검증이 완료된 정보를 얻는 것이 독서의 목적이다.'],
    ],
  },
  {
